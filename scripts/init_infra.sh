...
echo ""
echo "1. Configure Applications (Optional):"
echo "   Edit apps.config in $TARGET_DIR to enable/disable specific apps."
echo ""
echo "2. Start the Gateway (Nginx Proxy Manager):"
echo "   cd $TARGET_DIR/gateway"
echo "   docker compose up -d"
echo ""
echo "3. Start Core Services (Database):"
echo "   cd $TARGET_DIR/core-services"
echo "   docker compose up -d"
echo ""
echo "4. Start Management Services (Portainer):"
echo "   cd $TARGET_DIR/management"
echo "   docker compose up -d"
echo ""
echo "5. Run the orchestration setup:"
echo "   cd $TARGET_DIR"
echo "   ./setup.sh"
echo ""
